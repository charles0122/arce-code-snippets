...
export const site = 'https://snippets.arce.top/'
export const logo = 'https://snippets.arce.top/chodocs-logo.svg'
...
export const github = 'https://github.com/charles0122/arce-code-snippets'
